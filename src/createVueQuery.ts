...
import type { QueryFunctionContext as Context } from "@tanstack/vue-query";
...
const createVueQuery = (client: RegionsOfIndonesiaClient = new RegionsOfIndonesiaClient(), options: { name?: string } = {}) => {
